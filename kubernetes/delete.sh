...
kubectl delete pv ${namespace}--generic-user-home ${namespace}--hub-data ${namespace}--local-home ${namespace}--lsst-data ${namespace}--lsst-home ${namespace}--scratch ${namespace}--cryoem-home ${namespace}--cryoem-exp ${namespace}--gpfs ${namespace}--nfs
