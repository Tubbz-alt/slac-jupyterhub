...
kubectl delete pv ${namespace}--generic-user-home ${namespace}--hub-data ${namespace}--local-home ${namespace}--lsst-data ${namespace}--lsst-home ${namespace}--gpfs ${namespace}--nfs ${namespace}--scratch ${namespace}--tmp
